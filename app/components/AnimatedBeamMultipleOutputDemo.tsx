    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center gap-2">
          ...
          <Circle ref={div2Ref}>
          <Image 
              src="/assets/dealertracklogo.jpg" 
              alt="Dealer Track Logo" 
              width={200} 
              height={200} 
              className="w-full h-full object-contain"
            />
          ...
          <Circle ref={div3Ref}>
          <Image 
              src="/assets/dealercenter.jpg" 
              alt="Dealer Center Logo" 
              width={200} 
              height={200} 
              className="w-full h-full object-contain"
            />
          ...
          <Circle ref={div4Ref}>
          <Image 
              src="/assets/dealersocket.png" 
              alt="Dealer Socket Logo" 
              width={200} 
              height={200} 
              className="w-full h-full object-contain"
            />
